    ...
    <>
      ...
      <div className='mx-60'>
        <div className='flex justify-between w-full gap-4 '>
          ...
          <div className='w-full'>
            <label className='block cursor-pointer uppercase tracking-[.2em] text-[.8em] ' For="email">Email</label>
            <input className='border border-black  bg-white py-2 pl-3 w-full ' type="text" name='email' />
          </div>
        </div>
        <div className=' pt-10 mb-[30px]'>
          <div>
            ...
            <textarea className='border border-black w-full min-h-[100px] pl-3 pt-2 ' rows="5" id="Contact" name="contact[body]"></textarea>
          </div>
        </div>
      </div>
      <div className='flex justify-center'>
        <button className='bg-black text-white py-2 px-4 uppercase'>send</button>
      </div>
      </div>
    </>
  )
